  ...
  return (
    <div className="relative mb-16 last:mb-0">
      ...
      <div className={`flex ${isLeft ? 'flex-row' : 'flex-row-reverse'} items-center`}>
        ...
        <div className={`w-1/2 ${isLeft ? 'pr-10 text-right' : 'pl-10 text-left'}`}>
          <div className="text-purple-400 font-medium">{duration}</div>
        </div>
        
        {/* Timeline content - alternates left/right */}
        <div className="w-1/2">
          <div className={`bg-[#1a1a35] p-6 rounded-lg shadow-md border border-purple-900/30 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-purple-500/20 ${isLeft ? 'ml-10' : 'mr-10'} max-w-sm`}>
