        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-gray-300 text-lg">
              Welcome to my portfolio! I specialize in Natural Language
              Processing with {new Date().getFullYear() - 2019} years of
              experience turning ideas into production-grade solutions.
            </p>
